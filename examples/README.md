...
|---------|----------|------|
| [aws-cloudfront/](aws-cloudfront/) | AWS CloudFront Functions | `npm install` → `npm run init` → `npm run build` → deploy `dist/edge/viewer-request.js` |
| [cloudflare/](cloudflare/) | Cloudflare Workers | See cloudflare README (Workers codegen planned) |
