...
export const WAIVABLE_FINDING_RULE_IDS = [
  'SC-AUTHN-001', 'SC-AUTHN-002', 'SC-AUTHN-003', 'SC-AUTHN-004', 'SC-AUTHN-005', 'SC-AUTHN-006',
  'SC-AUTHZ-001', 'SC-AUTHZ-002',
  'SC-EXPOSURE-001', 'SC-EXPOSURE-002', 'SC-EXPOSURE-003', 'SC-EXPOSURE-004', 'SC-EXPOSURE-005',
  'SC-INVENTORY-001', 'SC-INVENTORY-002', 'SC-INVENTORY-003', 'SC-INVENTORY-004', 'SC-INVENTORY-005',
