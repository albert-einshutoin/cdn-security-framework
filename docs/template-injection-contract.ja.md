...
isolated bundler-backed prototype と、将来 plugin-safe emitter へ移行するための条件は
[ADR 0001: Plugin-Safe Emitter Path](./adr/0001-plugin-safe-emitter-path.ja.md) を参照してください。
