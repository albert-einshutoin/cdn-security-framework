...
- `SC-AUTHZ-001` (warning, high-confidence): explicitly configured `declaredPrivilegedRoles` differ from high-confidence Source role metadata. Route names and tags are never used to infer privilege.
