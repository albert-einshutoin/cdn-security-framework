...
| Contract / trust foundation (#271–#275) | Implemented | [Contract tests](../test/contract/) / [Public contract](./programmatic-api.md) |
| OpenAPI-aware policy (#276–#284) | Implemented | [OpenAPI tests](../test/openapi/) / [OpenAPI guide](./openapi-integration.md) |
